--[[
	Eternal's Edits:
	-Joystick turning (my bedroom is too cramped for physical turning lmao)
]]
...
cons.ic = uis.InputChanged:Connect(function(key)
    ...
    elseif key.KeyCode == Enum.KeyCode.Thumbstick2 then
        if key.Position.X >= 0.85 then
                cam.CFrame *= CFrame.Angles(0,math.rad(-5),0)
                wait(0.15)
        elseif key.Position.X <= -0.85 then
